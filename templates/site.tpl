            ...
            <div class=container-fluid>
                ...
                <div class="collapse navbar-collapse" id=bs-example-navbar-collapse-1>
                    <ul class="nav navbar-nav navbar-right respon_mobile_backcolor">
                        ...
                        <li class="text-center respon_mobile_itaime"><a href=https://zalati.fr/boutique><img src=https://zalati.fr/assets/images/shop.png width=50><br /><span class="hidden-sm hidden-xs">BOUTIQUE</span></a></li>
